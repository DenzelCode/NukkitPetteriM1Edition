...
public abstract class DefaultPermissions {
    ...
    public static void registerCorePermissions() {
        ...
        registerPermission(new Permission("nukkit.command.timings", "Allows the user to records timings for all plugin events", Permission.DEFAULT_OP), commands);
        ...
        registerPermission(new Permission("nukkit.command.world", "Allows the user to switch world", Permission.DEFAULT_OP), commands);
